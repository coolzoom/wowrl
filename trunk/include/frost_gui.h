...
namespace Frost
{
    namespace GUI
    {
        ...
        public :
            ...
            /** \param bRelativeToParent 'true' to substract its parent's
            *                            position
            *   \return This Anchor absolute X.
            */
            const s_int&       GetAbsX(s_bool bRelativeToParent = false);
            ...
            */
            const s_int&       GetAbsY(s_bool bRelativeToParent = false);
            ...
            */
            static AnchorPoint GetAnchorPoint(s_str sPoint);
