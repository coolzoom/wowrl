...
namespace GUI
{
    ...
    {
        Vertex();
        Vertex(const Vector2D& mPos, const Vector2D& mUV, const Color& mCol);
    ...
    */
    ...
    public :
        ...
        */
        Sprite(s_ptr<GUIManager> pManager);
        ...
        *         blank Material.
        */
        Sprite(s_ptr<GUIManager> pManager, const s_str& sTextureFile);
        ...
        */
        Sprite(s_ptr<GUIManager> pManager, const s_str& sTextureFile, const s_float& fWidth, const s_float& fHeight);
        ...
        *         of a real texture.
        */
        Sprite(s_ptr<GUIManager> pManager, const Color& mColor, const s_float& fWidth, const s_float& fHeight);

        /// Constructor.
        /** \param pManager The GUIManager this sprite has been created for.
        *   \param pRenderTarget The render target to read data from
        */
        Sprite(s_ptr<GUIManager> pManager, s_ptr<RenderTarget> pRenderTarget);
        ...
        *   \param fHeight The height of the Sprite
        */
        Sprite(s_ptr<GUIManager> pManager, s_ptr<RenderTarget> pRenderTarget, const s_float& fWidth, const s_float& fHeight);

        /// Constructor.
        Sprite(s_ptr<GUIManager> pManager, const Material& mMat);

        /// Constructor.
        Sprite(s_ptr<GUIManager> pManager, const Material& mMat, const s_float& fWidth, const s_float& fHeight);

        /// Constructor.
        Sprite(s_ptr<GUIManager> pManager, const Material& mMat, const s_float& fU, const s_float& fV, const s_float& fWidth, const s_float& fHeight);

        /// Copy constructor.
        Sprite(const Sprite& mSprite);
        ...
        *   \note Must be called between RenderTarget::Begin() and
        *         RenderTarget::End().
        */
        ...
        *         Must be called between RenderTarget::Begin() and
        *         RenderTarget::End().
        */
        ...
        */
        void SetHotSpot(const Vector2D& mHotSpot);
        ...
        */
        ...
        /// Returns a pointer to the implementation specific SpriteImpl.
        /** \return a pointer to the implementation specific SpriteImpl
        *   \note Using the SpriteImpl should be avoided, but this function
        *         remains here if you don't have the choice.
        */
        s_wptr<SpriteImpl> GetImpl();
