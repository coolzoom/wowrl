...
namespace GUI
{
    ...
    */
    ...
    public :
        ...
        */
        Text(s_ptr<GUIManager> pManager, const s_str& sFileName, const s_float& fSize);
        ...
        */
        s_refptr<Sprite> CreateSprite(const s_uint& uiChar) const;
