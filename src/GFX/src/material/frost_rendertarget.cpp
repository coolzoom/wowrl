...
namespace Frost
{
    ...
    RenderTarget::RenderTarget( const s_uint& uiWidth, const s_uint& uiHeight, const PixelType& mType, const Usage& mUsage )
    {
    ...
    RenderTarget::RenderTarget( const s_str& sName, const s_uint& uiWidth, const s_uint& uiHeight, const PixelType& mType, const Usage& mUsage )
    {
        if (!uiWidth.IsValid() || !uiHeight.IsValid())
        {
            throw Exception(CLASS_NAME,
