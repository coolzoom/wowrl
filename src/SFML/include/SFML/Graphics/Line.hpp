...
#ifndef SFML_LINE_HPP
#define SFML_LINE_HPP
...
///        vertices that composes the Line (position, color,
///        texture coordinates).
///
////////////////////////////////////////////////////////////
class SFML_API Line : public Drawable
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    Line(const Vector2f& p1, const Vector2f& p2, const Color& color = Color(255, 255, 255, 255));
    ...
    ///
    ////////////////////////////////////////////////////////////
    Line(const Vector2f& p1, const Color& c1, const Vector2f& p2, const Color& c2);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void SetStartPosition(const Vector2f& pos);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void SetEndPosition(const Vector2f& pos);
    ...
    ///
    ////////////////////////////////////////////////////////////
    const Vector2f& GetEndPosition() const;
...
/// \class sf::Line
///
/// sf::Line is a drawable class that allows to display an
...
/// sf::Line instance doesn't copy the image that it uses,
/// it only keeps a reference to it.
/// Thus, a sf::Image must not be destructed while it is
/// used by a sf::Line (i.e. never write a function that
