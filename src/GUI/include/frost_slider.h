    ...
    namespace GUI
    {
        ...
        */
        ...
        public :
            ...
            /// Constructor.
            Slider(s_ptr<GUIManager> pManager);
            ...
            */
            void           SetAllowClicksOutsideThumb(const s_bool& bAllow);

            /// Checks if clicks are allowed outside of the thumb.
            /** \return 'true' if it is the case
            *   \note See SetAllowClicksOutsideThumb().
            */
            const s_bool&  AreClicksOutsideThumbAllowed();
        ...
        protected :
            ...
            s_bool bAllowClicksOutsideThumb_;
        ...
        */
        ...
        public :
            ...
            // Glues
            int _AllowClicksOutsideThumb(lua_State*);
            int _GetMaxValue(lua_State*);
            int _GetMinValue(lua_State*);
            ...
            int _SetMaxValue(lua_State*);
            int _SetMinValue(lua_State*);
