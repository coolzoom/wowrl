...
namespace Frost
{
    ...
    public :
        ...
        */
        void            SetLongPressDelay(const s_double& dLongPressDelay);
        ...
        */
        const s_double& GetLongPressDelay() const;
        ...
        *   \note Calling SetFocus(false) doesn't immediately remove focus.
