            ...
            )
{
    ...
    float tMask = tex2D(mMask, iTexture).a;
    
    float4 tViewportPosition = float4(iTexture.x/mMaxUV.x*2.0 - 1.0, (1.0 - iTexture.y/mMaxUV.y)*2.0 - 1.0, oColor.a, 1.0);
    ...
    {
        tTempMask = tex2D(mMask, iTexture).a*tMask;
